...
export const Logout = ({ onClick }: { onClick?: () => void }) => <svg className={'icon'} onClick={onClick} width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
